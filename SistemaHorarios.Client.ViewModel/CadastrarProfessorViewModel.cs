...
{
    public class CadastrarProfessorViewModel : INotifyPropertyChanged
    {
        public CadastrarProfessorViewModel()
        {
            CriarEnabled = true;
        ...
        public void ExecutarCriar(object obj)
        {
            ...
            {
                MessageBox.Show("Insira um nome para o novo professor.");
                return;
            }
            ...
            var task = new Task(() =>
            {
                ...
                var model = new CadastrarProfessoresModel();
                model.Execute(new CadastrarProfessoresRequest()
                {
                    Nome = text
                });

                if (model.Response.Status == ExecutionStatus.Success) MessageBox.Show("Professor criado com sucesso!");
                else MessageBox.Show(string.Concat("Erro ao criar o professor:\n", model.Response.ErrorMessage));
