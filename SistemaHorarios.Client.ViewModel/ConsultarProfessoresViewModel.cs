...
{
    public class ConsultarProfessoresViewModel : INotifyPropertyChanged
    {
        public ConsultarProfessoresViewModel()
        {
            var task = new Task(() =>
            {
                Status = "Consultando...";
                var model = new ConsultarProfessoresModel();
                var request = new ConsultarProfessoresRequest();
        ...
        private List<ConsultarProfessoresProfessorDTO> _lista;
        public List<ConsultarProfessoresProfessorDTO> Lista
        {
